...
public abstract class AbstractEdocumentItem<T extends AbstractEdocumentItem<?>> extends DescriptionBaseEntity implements java.io.Serializable, Labelable, Businessable<T> {

	private static final long serialVersionUID = 3683810323859828658L;
