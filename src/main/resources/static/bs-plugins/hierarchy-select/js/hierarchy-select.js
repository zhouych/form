(function($){
    ...
    HierarchySelect.prototype = {
        ...
        disabledLevels: function() {
        	var emptyNodeValue = this.options.emptyNodeValue;
        	for(var i = 0, l = this.options.disabledLevels.length; i < l; i++) {
        		this.$menuInner.find('li[data-level="' + this.options.disabledLevels[i] + '"]').each(function(index) {
            		if(emptyNodeValue !== $(this).attr('data-value')) {
